...
| P05-T02 | 공개 목록·escaped ILIKE 검색·필터·페이지네이션 | in_progress | - |
...
- 진행 중: P04-T03 운영자 회차 CRUD·위아래 순서 이동 (Codex/p04_t03), P05-T02 공개 목록·escaped ILIKE 검색·필터·페이지네이션 (Codex/p05_t02)
- 리뷰 대기: 없음
- 다음 실행 가능: 없음 (P04-T03과 P05-T02 진행 중)
