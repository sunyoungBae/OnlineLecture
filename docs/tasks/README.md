...
| P06-T03 | 회차 자료 업로드·다운로드·삭제 | in_progress | U-B |
...
- 진행 중: P06-T02 게시글 첨부 업로드·서명 다운로드·정리 (Codex/p06_t02), P06-T03 회차 자료 업로드·다운로드·삭제 (Codex/p06_t03)
- 리뷰 대기: 없음
- 다음 실행 가능: 없음 (P06-T02와 P06-T03 진행 중)
