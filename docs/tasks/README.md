...
| P04-T03 | 운영자 회차 CRUD·위아래 순서 이동 | done | - |
| P05-T01 | Tiptap 제한 편집기와 게시글 CRUD | done | B-A |
| P05-T02 | 공개 목록·escaped ILIKE 검색·필터·페이지네이션 | done | - |
| P05-T03 | 댓글 CRUD·공지·운영자 삭제 | done | - |
| P06-T01 | 파일 allowlist·10MB/3개·80/95% 용량 로직 | done | U-A |
| P06-T02 | 게시글 첨부 업로드·서명 다운로드·정리 | in_progress | U-B |
| P06-T03 | 회차 자료 업로드·다운로드·삭제 | review | U-B |
...
- 진행 중: P06-T02 게시글 첨부 업로드·서명 다운로드·정리 (Codex/p06_t02)
- 리뷰 대기: P06-T03 회차 자료 업로드·다운로드·삭제 (Codex/p04_t01 승인)
- 다음 실행 가능: 없음 (P06-T02 진행, P06-T03 리뷰 중)
