...
| P05-T02 | 공개 목록·escaped ILIKE 검색·필터·페이지네이션 | review | - |
...
- 진행 중: P04-T03 운영자 회차 CRUD·위아래 순서 이동 (Codex/p04_t03)
- 리뷰 대기: P05-T02 공개 목록·escaped ILIKE 검색·필터·페이지네이션 (Codex/p04_t02 승인)
- 다음 실행 가능: 없음 (P04-T03 진행, P05-T02 리뷰 중)
