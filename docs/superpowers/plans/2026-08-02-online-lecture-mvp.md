...
| P07-T02 | 키보드·포커스·라벨·44px·WCAG AA·모바일 점검 | blocked | P07-T01 | - | 전역·공통 입력 컴포넌트와 인증·게시글·회차 화면 접근성 수정, 로컬 Supabase mock 기반 Playwright 검사 | 전 기능 UI·Playwright 설정 통합 소유 |
